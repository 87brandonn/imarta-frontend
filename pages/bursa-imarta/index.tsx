  ...
  return (
    <>
      ...
      <div className="p-5 mb-8 flex">
        <div className="flex-none w-1/3">
          ...
          <p className="font-light">
            ...
            dolores architecto facilis temporibus alias porro doloremque ducimus
            est fugiat quidem voluptas amet vitae animi totam. Dolor quam
            eveniet eligendi quos.
          </p>
        </div>
      ...
      <div className="p-5 mb-8">
        ...
        <div className="font-bold mb-3">https://linktr.ee/bursa.imarta</div>
        <div className="text-lg font-bold">INSTAGRAM</div>
        <div className="font-light mb-3">@bursaimarta</div>
        <div className="text-lg font-bold">LINE OFFICIAL ACCOUNT</div>
        <div className="font-light mb-3">@bursaimarta</div>
